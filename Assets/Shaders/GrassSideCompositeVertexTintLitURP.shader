Shader "Custom/GrassSideCompositeVertexTintLitURP"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes v)
            {
                ...
                o.uvOver = TRANSFORM_TEX(v.uv, _OverlayMap);
            ...
            {
                half4 b = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, i.uvBase);
                half4 o = SAMPLE_TEXTURE2D(_OverlayMap, sampler_OverlayMap, i.uvOver);

                half3 overlayRgb = o.rgb * i.color.rgb;
                half mask = o.a;
                half3 albedo = lerp(b.rgb, overlayRgb, mask);
